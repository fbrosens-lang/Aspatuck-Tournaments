-- Aspatuck Tournaments — widen team handicap range to -40..40.
--
-- 0057 narrowed to -20..20. TD wants more headroom in either direction.
...
alter table public.teams
  ...
  check (handicap is null or handicap between -40 and 40);
